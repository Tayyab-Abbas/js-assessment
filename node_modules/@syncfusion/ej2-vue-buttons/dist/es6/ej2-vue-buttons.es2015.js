...
class FabComponent extends ComponentBase {
    constructor() {
        super(arguments);
...
const FabPlugin = {
    name: 'ejs-fab',
    install(Vue$$1) {
        Vue$$1.component(FabPlugin.name, FabComponent);
    }
};
...
class SpeedDialItemsDirective extends vueImport$1 {
    constructor() {
        super(arguments);
    }
    render(createElement) {
...
SpeedDialItemsDirective = __decorate$7([
    EJComponentDecorator({}, isExecute)
    /* Start Options({
        inject: {
            custom: {
...
const SpeedDialItemsPlugin = {
    ...
    install(Vue$$1) {
        Vue$$1.component(SpeedDialItemsPlugin.name, SpeedDialItemsDirective);
    }
};
/**
 ...
 * ```
 */
let SpeedDialItemDirective = class SpeedDialItemDirective extends vueImport$1 {
    render() {
        return;
    }
    getTag() {
...
SpeedDialItemDirective = __decorate$7([
    EJComponentDecorator({}, isExecute)
], SpeedDialItemDirective);
const SpeedDialItemPlugin = {
    name: 'e-speeddial-item',
    install(Vue$$1) {
        Vue$$1.component(SpeedDialItemPlugin.name, SpeedDialItemDirective);
    }
};
...
class SpeedDialComponent extends ComponentBase {
    constructor() {
        super(arguments);
        ...
        this.hasChildDirective = true;
        this.hasInjectedModules = false;
        this.tagMapper = { "e-speeddial-items": "e-speeddial-item" };
        this.tagNameMapper = { "e-speeddial-items": "e-items" };
        this.isVue3 = !isExecute;
        this.ej2Instances = new SpeedDial({});
        this.ej2Instances._trigger = this.ej2Instances.trigger;
        this.ej2Instances.trigger = this.trigger;
        this.bindProperties();
        this.ej2Instances._setProperties = this.ej2Instances.setProperties;
...
SpeedDialComponent = __decorate$8([
    EJComponentDecorator({
        props: properties$6,
        model: {
            event: 'modelchanged'
...
const SpeedDialPlugin = {
    name: 'ejs-speeddial',
    install(Vue$$1) {
        Vue$$1.component(SpeedDialPlugin.name, SpeedDialComponent);
        Vue$$1.component(SpeedDialItemPlugin.name, SpeedDialItemDirective);
        Vue$$1.component(SpeedDialItemsPlugin.name, SpeedDialItemsDirective);
    }
};

export { ButtonComponent, ButtonPlugin, CheckBoxComponent, CheckBoxPlugin, RadioButtonComponent, RadioButtonPlugin, SwitchComponent, SwitchPlugin, ChipsDirective, ChipDirective, ChipsPlugin, ChipPlugin, ChipListComponent, ChipListPlugin, FabComponent, FabPlugin, SpeedDialItemsDirective, SpeedDialItemDirective, SpeedDialItemsPlugin, SpeedDialItemPlugin, SpeedDialComponent, SpeedDialPlugin };
